...
This repository contains code examples and documentation you will see during practice lectures (2025 Fall).
...
#### Polyglot Notebook Files (*.dib)
Many examples are provided as `*.dib` files - Polyglot Notebook (previously called .NET Notebook) format.
...
🚀 **Live Demonstrations**: Follow along with language features and development practices using the [PSI2025-Playground repository](https://github.com/niku-live/PSI2025-Playground)
